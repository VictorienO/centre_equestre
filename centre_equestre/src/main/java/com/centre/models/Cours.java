...
public class Cours {
    ...
    public Cours(int id_cours, String discipline, String date_cours, String heure, float duree, int niveau_requis, int nbr_cavalier_max, String prof, List<Cavalier> cavaleirs) {
    ...
    public void setCavaleirs(List<Cavalier> cavaliers) {
        this.cavaliers = cavaliers;
    }
